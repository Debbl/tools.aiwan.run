...
### 基本操作
1. **输入代码**: 在左右两个编辑器中输入要对比的代码
2. **自动对比**: 系统会自动分析并显示代码差异
3. **查看差异**: 差异部分会用不同颜色高亮显示
4. **实时编辑**: 可以在对比界面中实时编辑代码
...
### Basic Operations
1. **Input Code**: Enter the code to compare in the left and right editors
2. **Auto Comparison**: System automatically analyzes and displays code differences
3. **View Differences**: Differences are highlighted with different colors
4. **Real-time Editing**: Can edit code in real-time in the comparison interface
