...
### 基本操作
1. **选择骰子**: 选择要投掷的骰子类型和数量
2. **投掷骰子**: 点击投掷按钮或拖拽骰子进行投掷
3. **查看结果**: 观察骰子的投掷过程和最终结果
4. **重复投掷**: 可以连续投掷多次查看不同结果
...
### Basic Operations
1. **Select Dice**: Choose the type and number of dice to roll
2. **Roll Dice**: Click the roll button or drag dice to roll
3. **View Results**: Observe the rolling process and final results
4. **Repeat Rolling**: Can roll multiple times to see different results
